...
const PostCard = ({ post }) => (
  ...
  >
    ...
    <div className="p-3">
      <h3 className="font-medium text-gray-900 text-sm lg:text-base mb-2 line-clamp-2">{post.title}</h3>
      <div className="flex items-center justify-between text-xs lg:text-sm text-gray-500">
        <div className="flex items-center">
          ...
          />
          <span className="truncate max-w-[4rem] lg:max-w-[8rem] text-gray-600">{post.user.name}</span>
        </div>
        <div className="flex items-center">
